...
################################################################################
    ...
    if (test == TRUE & !is.null(attr(CatTable, "pValues"))) {
        ...
        p <- sprintf(fmt = fmt, attr(CatTable, "pValues"))
